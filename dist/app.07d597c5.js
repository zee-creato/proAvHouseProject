...
window.addEventListener('DOMContentLoaded', function () {
  ...
  gorgeDevice.innerHTML = devicesDiv; // gorgeDevice.className='container__main__box__left__georgeHome__device swiper slider1'

  var swiper = new Swiper('slider1', (_Swiper = {
    speed: 400,
    effect: 'slide',
    slidesPerView: 4
  }, _defineProperty(_Swiper, "speed", 900), _defineProperty(_Swiper, "centeredSlides", true), _Swiper));
});
selector.addEventListener('change', function (e) {
...
function displayMenuRooms(zee) {
  ...
  gorgeDevice.className = 'swiper-wrapper zee2';
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var swiper2 = new Swiper('.arnold', (_Swiper2 = {
    speed: 20,
    effect: 'slide',
    slidesPerView: 4
  }, _defineProperty(_Swiper2, "speed", 900), _defineProperty(_Swiper2, "spaceBetween", 10), _Swiper2));
});
},{}]},{},["A2T1"], null)
//# sourceMappingURL=app.07d597c5.js.map