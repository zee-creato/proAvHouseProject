...
window.addEventListener('DOMContentLoaded', function () {
  ...
  devicesDiv = devicesDiv.join('');
  deviceDivContainer.innerHTML = devicesDiv; // deviceDivContainer.className='container__main__box__right__device__boxesContainer swiper-wrapper'
  ...
  var swiper3 = new Swiper('.slider3', {
    ...
    speed: 900,
    spaceBetween: 10,
    slidesPerGroupAuto: true //  roundLengths: true,
...
function displayMenuDevice(device3) {
  ...
  devicesDiv = devicesDiv.join('');
  deviceDivContainer.innerHTML = devicesDiv; // devicesDiv.className='container__main__box__right__device__boxesContainer device-wraper  swiper-wrapper'
...
var opcje = document.querySelector('option');
userSelect.addEventListener('change', function (e) {
  var category = e.target.value;
...
var topB = document.querySelector('.top');
var bottomB = document.querySelector('.bottom');
var svg = document.querySelectorAll('.z');
var svg2 = document.querySelector('.container__nav__li svg');
var welcomeH1 = document.querySelector('.container__main__box__left__welcome__h1');
var topBarClock = document.querySelector('.container__main__topBar__clock__data');
var topBarClock2 = document.querySelector('.container__main__topBar__clock__hour');
var mainCointr = document.querySelector('.container__main');
var Cointr = document.querySelector('.container');
var userSelectDad = document.querySelector('.container__main__topBar__user__userSelect__btn');
var mainBoxRight = document.querySelector('.container__main__box__right');
var rightConsumed = document.querySelector('.container__main__box__right__consumed');
var extention = document.querySelector('.extensions');
var newUser = document.querySelector('.container__main__box__right__members__icons');
var userStart = document.querySelectorAll('.container__main__box__right__members__icons__users');
var option = document.querySelector('.option');
var activeIcons = document.querySelector('.container__main__box__right__members__icons__users__active');
var c = document.getElementById('iconSelection');
var membersIcon = document.querySelector('.container__main__box__right__members__icons');
var userIconsPs = document.querySelectorAll('.container__main__box__right__members__icons__users__pS');
var conNav = document.querySelector('.container__nav__li active');
var selectorsActive = document.querySelector('.selector-active');
userStart.forEach(function (user) {
  user.addEventListener('click', function (e) {
    ...
    if (category === 'Dad') {
      ...
      userIconsPs.forEach(function (l) {
        return l.style.color = 'white';
      });
      bb.style.background = dadNavColor;
      svg.forEach(function (f) {
        return f.style.fill = dadListItems;
      });
      ...
      var activeTop = document.querySelector('.selector-active .top').classList.add('dadActive');
      var activeBottomo = document.querySelector('.selector-active .bottom').classList.add('dadActive');
    ...
    var userIcon = userIcons.filter(function (user) {
    ...
    usersSpan.forEach(function (r) {
      if (category === r.dataset.name) {
        ...
        r.classList.remove('active', "".concat(r.dataset.name));
      }
    });
    ...
    switch (category) {
      case 'George':
        welcomeUser.textContent = category;
        userHome.textContent = "".concat(category, "'s");
        spanUserText.textContent = "".concat(category);
        break;
...
function userIconsSelect2(category) {
  var devicesDiv = category.map(function (item) {
    return "    \n    \n  \n  \n    <img src=".concat(item.icon, "/>\n  \n  \n  \n  \n  \n          ");
  });
  devicesDiv = devicesDiv.join('');
  spanIcon.innerHTML = devicesDiv;
...
var con = document.querySelectorAll('.container__main__box__right__members__icons__users');
var userPanel = document.querySelector('.container__main__box__right__userPanel');
var spanUserText = document.querySelector('.container__main__topBar__user__userSelect__btn__span');
var userSelectBtn = document.querySelector('.container__main__topBar__user__userSelect__btn');
var ulUserSelection = document.querySelector('.container__main__box__right__userPanel__ul');
userSelectBtn.addEventListener('click', function (e) {
...
ulUserSelection.addEventListener('click', function (e) {
  var category = e.target.dataset.user;
  var category1 = e.currentTarget.dataset.name;
  var userIcon = userIcons.filter(function (user) {
    if (user.name === category) {
      return category;
    }
...
//# sourceMappingURL=app.8df57919.js.map