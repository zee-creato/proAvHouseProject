...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var swiper = new Swiper('.swiper', (_Swiper = {
    ...
    effect: 'slide',
    slidesPerView: 4
  }, _defineProperty(_Swiper, "speed", 900), _defineProperty(_Swiper, "spaceBetween", 10), _Swiper));
});
selector.addEventListener('change', function (e) {
...
function displayMenuRooms(zee) {
  ...
  gorgeDevice.innerHTML = devicesDiv;
  gorgeDevice.className = 'swiper-wrapper zee2';
  var swiper = new Swiper('.swiper', (_Swiper2 = {
    speed: 400,
    effect: 'slide',
    slidesPerView: 4
...
//# sourceMappingURL=app.cd6eef7c.js.map