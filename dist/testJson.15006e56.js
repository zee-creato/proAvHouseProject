...
var gorgeDevice1 = document.querySelector('.zee2');
window.addEventListener('DOMContentLoaded', function () {
  fetch('icons.json').then(function (response) {
    ...
    var html = data.map(function (user) {
      ...
      }, _defineProperty(_Swiper, "speed", 900), _defineProperty(_Swiper, "centeredSlidesBounds", true), _Swiper)); /////////////////////////////On Change ////////////////////////////////////////

      selector.addEventListener('change', function (e) {
        var category = e.target.value;
        var roomCategory = data.filter(function (menuItem) {
    ...
    console.log(html); // document.querySelector('div').innerHTML=html
  }).catch(function (error) {
    console.log('Error');
  });
});
},{}]},{},["de5H"], null)
//# sourceMappingURL=testJson.15006e56.js.map